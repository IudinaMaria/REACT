 ...
 * Позволяет пользователю вводить поисковый запрос и очищать поле ввода.
 * Включает в себя дебаунс для оптимизации запросов и контекст для синхронизации данных с другими компонентами.
 *
 * @component
 */
const Search = () => {
  ...
  /**
   * Функция для обновления значения поиска с использованием дебаунса.
   * Отправляет запрос на обновление контекста через `setSearchValue`.
   *
   ...
   * Обновляет локальное состояние и передает значение в контекст.
   *
